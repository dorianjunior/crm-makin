        ...
        <div class="page-container">
            <div class="page-header">
                <div class="page-header__content">
                    <h1 class="page-header__title">EDITAR LEAD</h1>
                    <p class="page-header__subtitle">Atualize as informações do lead</p>
                </div>
            </div>
...
const submit = () => {
    ...
    form.put(`/leads/${props.lead.id}`, {
        preserveScroll: true,
        onSuccess: () => {
            alert.success('Lead atualizado com sucesso!');
        },
        onError: (errors) => {
            alert.error('Erro ao atualizar lead. Verifique os campos.');
        },
    });
};
