  ...
  .card-header {
    ...
    .service-info {
      ...
      .service-icon {
        ...
        &.instagram { background: linear-gradient(135deg, #E4405F, #F77737, #FCAF45); }
        &.google { background: linear-gradient(135deg, #4285F4, #34A853); }
        &.sendgrid { background: linear-gradient(135deg, #1A82E2, #00A4E4); }
        &.zapier { background: linear-gradient(135deg, #FF4A00, #FF6A00); }
        &.stripe { background: linear-gradient(135deg, #635BFF, #8A85FF); }
        &.analytics { background: linear-gradient(135deg, #E37400, #F9AB00); }
