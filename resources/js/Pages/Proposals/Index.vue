    ...
    <MainLayout title="Propostas Comerciais">
        ...
        <div class="page-container">
            ...
            <div class="stats-grid">
                <StatCard title="Total de Propostas" :value="stats.total" icon="fa-file-invoice-dollar" />
                <StatCard title="Rascunhos" :value="stats.draft" icon="fa-file" />
                <StatCard title="Enviadas" :value="stats.sent" icon="fa-paper-plane" />
                <StatCard title="Aprovadas" :value="stats.approved" icon="fa-check-circle" />
            </div>
            ...
            <div class="filters-card">
                ...
                <div class="filters-grid">
                    ...
                    <Select v-model="filters.status" :options="statusOptions" placeholder="Todos os status"
            ...
            <Table :columns="tableColumns" :data="proposals.data" striped hoverable>
                ...
                <template #cell-lead="{ row }">
                    <div class="lead-info">
                        <p class="font-semibold">{{ row.lead?.name }}</p>
                        <small v-if="row.lead?.email" class="text-secondary">{{ row.lead.email }}</small>
                    </div>
                </template>
                ...
                <template #cell-actions="{ row }">
                    <div class="action-buttons">
                        ...
                        <button v-if="row.status === 'draft'" @click="sendProposal(row)" class="action-btn success"
                            title="Enviar">
            ...
            <!-- Pagination -->
            <Pagination :current-page="proposals.current_page" :last-page="proposals.last_page" :from="proposals.from"
                :to="proposals.to" :total="proposals.total" @page-change="handlePageChange" />
        </div>
